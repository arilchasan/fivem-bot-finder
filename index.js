...
const servers = [
    ...
    { name: "BOZ", alias: "boz", id: "8z49xm" },
    { name: "STATE OF INDONESIA", alias: "soi", id: "jygd5m" },
    { name: "KOTAKITA", alias: "kotkit", id: "r35px8" },
    { name: "IME RP", alias: "ime", id: "zrvmg4" },
    { name: "CERITA ROLEPLAYKU IDN", alias: "cri", id: "pmj7by" },
    { name: "BERSAMA V2", alias: "bersamav2", id: "lqzmjv" },
    { name: "CERITA KITA", alias: "ck", id: "zxmea5" },
    { name: "NUESTRO", alias: "nuestro", id: "kb86br" },
    ...
    { name: "NOCTIS", alias: "noctis", id: "8r5lp3" },
    { name: "SENTRA NUSANTARA", alias: "sentra", id: "3m5opb" },
    { name: "SEMJAKALA", alias: "senjakala", id: "z5oaqp" },
